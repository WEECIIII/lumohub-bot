...
local function LoadLumoHub(activeKey, authGui)
    if game.GameId == 4777817887 or game.PlaceId == 13772394625 or workspace:FindFirstChild("Balls") then
        ...
        local function Parry()
            -- Anti-Cheat bypass: humanized delay between mouse down and up
                    ...
                    if IsTarget() then
                        ...
                        if char and char:FindFirstChild("HumanoidRootPart") then
                            ...
                            if Velocity > 0 then
                                ...
                                -- Anti-Cheat bypass: 0.3s cooldown to prevent 60-CPS click spamming
                                if TimeToImpact <= ParryDistance and (tick() - lastAutoParry > 0.3) then
                                    lastAutoParry = tick()
                                    Parry()
                                end
                            end
